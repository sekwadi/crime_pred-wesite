...
<p style="font-size: 3rem; text-align:center" class="fw-light">Access admin panel</p>
...
<br>
  <button name="login_admin" style="width:100%;" type="submit" class="btn btn-primary">Login</button>
</form>
