...
<section style="font-size: 3rem; padding:1rem; background-color:#0d6efd; color:white; ">
    <h1 style="font-weight:600">Dashbord > Case > Edit</h1>
</section>
...
<?php } ?>
 ...
 <div class="tile is-ancestor">
  <div class="tile is-parent">
    ...
    <form action="./admin_edit_crime.php" method="post">
...
<?php }?>
      ...
      <div class="field is-grouped">
        ...
        <div class="control">
          <button class="button is-link is-light"><a href="./admin_crime.php">Cancel</a> </button>
        </div>
      </div>
      </form>
...
<script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB41DRUbKWJHPxaFjMAwdrzWzbVKartNGg&callback=getLocation&v=weekly"
      defer
    ></script>
