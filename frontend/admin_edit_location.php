...
$id = $_SESSION['del_loc_id'];
$sql = "SELECT * from location WHERE location_id = '$id'";
$location_info = mysqli_query($conn, $sql);
$location_info = mysqli_fetch_assoc($location_info);
...
$sql = '';
$sql = "UPDATE location SET name = '$name', latitude = '$lat', longitude = '$long' WHERE location_id = '$id'";
$location_info = mysqli_query($conn, $sql);

header('location:./admin_home.php?msg=Location updated successfully');
...
<head>
    ...
    <title>Edit Location | Crime Prediction</title>
</head>
<body>
...
<section style="font-size: 3rem; padding:1rem; background-color:#0d6efd; color:white; ">
    <h1 style="font-weight:600">Dashbord > User > Edit</h1>
</section>
...
<div class="tile is-ancestor">
  <div class="tile is-parent">
    ...
    <h1 class="title">Location Information</h1>
    <form action="./admin_edit_location.php" method="post">


      <div class="field">
        <label class="label">City & Country </label>
        <div class="control">
          <input required name="location" value="<?php echo $location_info['name'] ?>" class="input" type="text" placeholder="">
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="control">
          <input required name="lat" value="<?php echo $location_info['latitude'] ?>" class="input" type="text" placeholder="">
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="control">
          <input  name="long" value="<?php echo $location_info['longitude'] ?>" class="input" type="text" placeholder="">
        </div>
      </div>
      ...
      <div class="field is-grouped">
        <div class="control">
          <button name="update_location" type="submit" class="button is-link">Update Location</button>
        </div>
        <div class="control">
