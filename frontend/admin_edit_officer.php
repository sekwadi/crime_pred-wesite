...
$id = $_SESSION['del_officer_id'];
$sql = "SELECT * from officer WHERE officer_id = '$id'";
$officer_res = mysqli_query($conn, $sql);
$officer_res = mysqli_fetch_assoc($officer_res);
...
if(strlen($id) != 13){
   header('location:../frontend/admin_edit_officer.php?msg=Invalid ID number length');
   exit;
}else{
 ...
 //  echo($id_year);
   ...
   if($id_year >= $current_year){
       header('location:../frontend/admin_edit_officer.php?msg=Invalid ID number year');
       exit;
   }
  ...
  if($id_month < 1 || $id_month > 12 ){
       header('location:./frontend/admin_edit_officer.php?msg=Invalid ID number month');
       exit;
   }
   ...
   if($id_day < 1 || $id_day > 31 ){
       header('location:./frontend/admin_edit_officer.php?msg=Invalid ID number day');
       exit;
   }  
}
...
// validate phone number
   ...
   if(preg_match('/^[0-9]{10}+$/', $phone)) {
       ...
       header('location:./frontend/admin_edit_officer.php?msg=Invalid phone number');
       exit;
   }
  

   if($validated){
      $sql = "UPDATE officer SET officer_id = '$id' , fname = '$fname', lname = '$lname', phone = '$phone', email = '$email' WHERE officer_id = '$id'";
          
      mysqli_query($conn, $sql);
      header('location:../frontend/admin_officer.php?msg=Crime info added successfully');

      $id = '';
    
      exit;
    }else{
      header('location:../frontend/admin_officer.php?msg=Something wrong with the info provided');
      exit;
   }
...
<head>
    ...
    <title>Edit Officer | Crime Prediction</title>
</head>
<body>
...
<div class="tile is-ancestor">
  <div class="tile is-parent">
    ...
    <div class="field">
        ...
        <div class="control">
          <input required name="id" value="<?php echo $officer_res['officer_id']?>" class="input" type="text"  placeholder="">
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="control">
          <input required name="fname" value="<?php echo $officer_res['fname']?>" class="input" type="text" placeholder="">
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="control">
          <input required name="lname" value="<?php echo $officer_res['lname']?>" class="input" type="text" placeholder="">
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="control">
          <input  name="email" value="<?php echo $officer_res['email']?>" class="input" type="tel" placeholder="">
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="control">
          <input required name="phone" value="<?php echo $officer_res['phone']?>" class="input" type="tel" placeholder="">
        </div>
      </div>
      ...
      <div class="field is-grouped">
        <div class="control">
          <form action="./admin_edit_officer.php" method="post">
            <button name="edit_officer" class="button is-link">Update Officer</button>
